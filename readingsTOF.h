...
/*
  Serial.print("Sensor 1 Distnace : ");Serial.print(distancearray[0]);
  Serial.print(" Sensor 2 Distnace : ");Serial.print(distancearray[1]);
  Serial.print(" Sensor 3 Distnace : ");Serial.println(distancearray[2]);*/
